...
class GaussianDiffusion:
    ...
    def _vb_terms_bpd(
        self, model, x_start, x_t, y, t, clip_denoised=True, model_kwargs=None, mask=None
    ):
        """
    ...
    def training_losses(
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            # HACK: call the forward pass of SDiT
            # y: text-embedding
